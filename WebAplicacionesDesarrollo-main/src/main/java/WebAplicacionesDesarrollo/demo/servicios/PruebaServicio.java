...
public class PruebaServicio {
    ...
    public PruebaServicio(PruebaRepository pruebaRepository, SlotRepository slotRepository, MateriaRepository materiaRepository, ConvocatoriaRepository convocatoriaRepository) {
    ...
    public PruebaDTO obtenerPruebaPorId(Long id) {
        Prueba prueba = pruebaRepository.findById(id)
                .filter(p -> !p.isEliminada()) // Añadimos el filtro de borrado lógico
